<% @Page Language="C#" MasterPageFile="Main.master" AutoEventWireup="true" Src="ActualizarClientes.aspx.cs" Inherits="Default" Title="E-Commerce" %>
        ...
        <div class="container">
            <div class="registrarP">
                ...
                <form class="form-Rproducto">
                    ...
                    <asp:Button ID="btnActualizar" runat="server" Text="Actualizar cliente" OnClick="btnActualizarC_Click" />
